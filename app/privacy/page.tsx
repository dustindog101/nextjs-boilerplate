        ...
        <div className="min-h-screen flex flex-col">
            <div className="max-w-3xl mx-auto w-full px-4 sm:px-6 lg:px-8 py-12 sm:py-20 flex-grow">
                ...
                <div className="prose prose-sm max-w-none space-y-8 animate-fade-up delay-2">
                    ...
                    <section>
                        <h2 className="text-lg font-semibold text-[var(--text-primary)] mb-2">2. How We Use Your Information</h2>
                        <p className="text-[var(--text-secondary)] leading-relaxed">
                    ...
                    <section>
                        <h2 className="text-lg font-semibold text-[var(--text-primary)] mb-2">3. Data Security</h2>
                        <p className="text-[var(--text-secondary)] leading-relaxed">
                    ...
                    <section>
                        <h2 className="text-lg font-semibold text-[var(--text-primary)] mb-2">4. Sharing of Information</h2>
                        <p className="text-[var(--text-secondary)] leading-relaxed">
                    ...
                    <section>
                        <h2 className="text-lg font-semibold text-[var(--text-primary)] mb-2">5. Cookies</h2>
                        <p className="text-[var(--text-secondary)] leading-relaxed">
                    ...
                    <section>
                        <h2 className="text-lg font-semibold text-[var(--text-primary)] mb-2">6. Your Rights</h2>
                        <p className="text-[var(--text-secondary)] leading-relaxed">
