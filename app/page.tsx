    ...
    return (
        <div className="bg-gradient-to-r from-[var(--accent-subtle)] via-[var(--bg-secondary)] to-[var(--accent-subtle)] border-b border-[var(--border)]">
            <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-2.5 flex items-center justify-between gap-4">
                ...
                <button onClick={handleDismiss} className="text-[var(--text-tertiary)] hover:text-[var(--text-secondary)] transition-colors cursor-pointer flex items-center justify-center min-h-11 min-w-11" aria-label="Dismiss">
...
function FloatingSupport() {
    ...
    const hideOnRoutes = ['/order/new', '/checkout'];
    ...
    return (
        <a
            ...
            className="fixed bottom-[calc(1.5rem+env(safe-area-inset-bottom,0px))] right-4 sm:right-6 z-30 flex items-center gap-2 bg-[#0088cc] hover:bg-[#0077b5] text-white px-4 py-3 min-h-11 rounded-full shadow-lg hover:shadow-xl transition-all animate-fade-up delay-8"
        >
                ...
                <div className="max-w-6xl mx-auto relative z-10">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
                        ...
                        <div>
                            ...
                            {/* Stat counters */}
                            <div className="flex flex-wrap items-center justify-center sm:justify-start gap-4 sm:gap-6 sm:gap-10 mt-8 animate-fade-up delay-5">
