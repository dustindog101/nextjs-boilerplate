      ...
      <div className="max-w-6xl mx-auto w-full px-4 sm:px-6 lg:px-8 py-8 sm:py-12 flex-grow">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-4 mb-8 sm:mb-10">
          {[
            ...
            >
              ...
              <p className={`text-2xl font-bold ${stat.isPrice ? 'text-price' : 'text-white'}`}>
                {stat.value}
              </p>
            </div>
          ))}
        ...
        <section>
          <div className="flex items-center justify-between mb-5">
            ...
            <Link href="/order" className="text-xs text-indigo-400 hover:text-indigo-300 transition-colors">
              + New Order
            </Link>
          </div>
          ...
          {isLoading ? (
            ...
            <div className="glass p-8 text-center">
              <p className="text-zinc-300 font-semibold mb-1">No orders yet</p>
