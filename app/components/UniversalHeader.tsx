// --- START OF FILE app/components/UniversalHeader.tsx (Updated) ---
      ...
      <div className="flex-shrink-0 relative">
        {isLoading ? (
          ...
          <div ref={dropdownRef} className="relative group">
            ...
            <div className={`absolute right-0 mt-2 w-48 bg-gray-700 border border-gray-600 rounded-lg shadow-lg py-1 z-50 transition-all duration-200 ease-out ${isDropdownOpen ? 'opacity-100 translate-y-0 visible' : 'opacity-0 -translate-y-2 invisible'}`}>
          ...
          <a href="/account" className="bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-lg text-md transition-colors shadow-md">Login</a>
        )}
      </div>
    </header>
  );
...
// --- END OF FILE app/components/UniversalHeader.tsx (Updated) ---