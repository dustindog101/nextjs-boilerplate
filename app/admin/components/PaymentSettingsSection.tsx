...
import { adminGetPaymentSettings, adminUpdatePaymentSettings } from '@/lib/payments';
  ...
  if (gatewayUnavailable) {
    return (
      <div className="p-6 sm:p-8 max-w-2xl">
        <h1 className="text-2xl font-bold text-[var(--text-primary)] mb-3">Crypto Pay</h1>
    ...
    <div className="p-6 sm:p-8 max-w-4xl">
      <header className="mb-8 animate-fade-up">
        <div className="flex items-center gap-3 mb-2">
          ...
          <h1 className="text-2xl sm:text-3xl font-bold text-[var(--text-primary)]">Crypto Payments</h1>
        </div>
        <p className="text-sm text-[var(--text-secondary)]">
          Enable assets and deposit addresses. Customers receive a unique invoice amount; the watcher
          confirms on-chain payments automatically.
        </p>
      </header>

      <div className="glass p-5 sm:p-6 mb-6 animate-fade-up delay-1">
        ...
        />
        <p className="text-xs text-[var(--text-tertiary)] mt-2">Default 48h. Unpaid invoices expire and can be regenerated.</p>
      </div>
          ...
          return (
            <div key={asset.id} className="glass p-5 sm:p-6">
              <div className="flex flex-wrap items-center justify-between gap-4 mb-4">
                <div>
                  <h2 className="text-lg font-semibold text-[var(--text-primary)]">{asset.label}</h2>
