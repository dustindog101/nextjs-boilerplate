    ...
    return (
        <div className="min-h-screen flex flex-col">
            <div className="max-w-3xl mx-auto w-full px-4 sm:px-6 lg:px-8 py-12 sm:py-20 flex-grow">
                ...
                <h1 className="text-3xl sm:text-4xl font-bold text-[var(--text-primary)] tracking-tight mb-2 animate-fade-up">
                    Terms of Service
                </h1>
                <p className="text-sm text-[var(--text-secondary)] mb-10 animate-fade-up delay-1">
                ...
                <div className="prose prose-sm max-w-none space-y-8 animate-fade-up delay-2">
                    ...
                    <section>
                        <h2 className="text-lg font-semibold text-[var(--text-primary)] mb-2">2. Use of Service</h2>
                        <p className="text-[var(--text-secondary)] leading-relaxed">
                    ...
                    <section>
                        <h2 className="text-lg font-semibold text-[var(--text-primary)] mb-2">3. Account Responsibilities</h2>
                        <p className="text-[var(--text-secondary)] leading-relaxed">
                    ...
                    <section>
                        <h2 className="text-lg font-semibold text-[var(--text-primary)] mb-2">4. Orders & Payments</h2>
                        <p className="text-[var(--text-secondary)] leading-relaxed">
                    ...
                    <section>
                        <h2 className="text-lg font-semibold text-[var(--text-primary)] mb-2">5. Shipping & Delivery</h2>
                        <p className="text-[var(--text-secondary)] leading-relaxed">
                    ...
                    <section>
                        <h2 className="text-lg font-semibold text-[var(--text-primary)] mb-2">6. Refunds</h2>
                        <p className="text-[var(--text-secondary)] leading-relaxed">
                    ...
                    <section>
                        <h2 className="text-lg font-semibold text-[var(--text-primary)] mb-2">7. Limitation of Liability</h2>
                        <p className="text-[var(--text-secondary)] leading-relaxed">
