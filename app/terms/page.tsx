        ...
        <div className="min-h-screen flex flex-col">
            <div className="max-w-3xl mx-auto w-full px-4 sm:px-6 lg:px-8 py-12 sm:py-20 flex-grow">
                ...
                <div className="prose prose-sm max-w-none space-y-8 animate-fade-up delay-2">
                    ...
                    <section>
                        <h2 className="text-lg font-semibold text-slate-900 mb-2">2. Use of Service</h2>
                        <p className="text-slate-500 leading-relaxed">
                    ...
                    <section>
                        <h2 className="text-lg font-semibold text-slate-900 mb-2">3. Account Responsibilities</h2>
                        <p className="text-slate-500 leading-relaxed">
                    ...
                    <section>
                        <h2 className="text-lg font-semibold text-slate-900 mb-2">4. Orders & Payments</h2>
                        <p className="text-slate-500 leading-relaxed">
                    ...
                    <section>
                        <h2 className="text-lg font-semibold text-slate-900 mb-2">5. Shipping & Delivery</h2>
                        <p className="text-slate-500 leading-relaxed">
                    ...
                    <section>
                        <h2 className="text-lg font-semibold text-slate-900 mb-2">6. Refunds</h2>
                        <p className="text-slate-500 leading-relaxed">
